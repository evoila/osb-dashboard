...
describe('NgbTime', () => {
  ...
  it('should have a validity flag', () => {
    ...
    expect(new NgbTime(100, 0, 30).isValid()).toBeFalsy();
    expect(new NgbTime(11, 100, 30).isValid()).toBeFalsy();
    expect(new NgbTime(11, 0, 100).isValid()).toBeFalsy();
    expect(new NgbTime(100, 0, 100).isValid()).toBeFalsy();
    expect(new NgbTime(100, 100, 100).isValid()).toBeFalsy();
  });
