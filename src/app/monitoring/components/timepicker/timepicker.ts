...
import {isInteger, isNumber, padNumber, toInteger} from './util';
...
export class NgbTimepicker implements ControlValueAccessor,
  ...
  private propagateModelChange(touched = true) {
    ...
    if (this.model.isValid(this.seconds)) {
      ...
      const emptyTime = new NgbTime(0, 0, 0);
      this.onChange(this._ngbTimeAdapter.toModel(emptyTime));
    }
  }
}